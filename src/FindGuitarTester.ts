...
export class FindGuitarTester {
  ...
  private initializeInventory(inventory: Inventory) {
    ...
    inventory.addInstrument("70108276", 2295.95, new GuitarSpec(Builder.GIBSON, "Les Paul", Type.ELECTRIC, Wood.MAHOGANY, Wood.MAPLE, 6));
    ...
    inventory.addInstrument("1092", 12_995.95, new GuitarSpec(Builder.OLSON, "SJ", Type.ACOUSTIC, Wood.INDIAN_ROSEWOOD, Wood.CEDAR, 12));
